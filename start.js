...
var headlessWallet = require('trustgraph-headless');
var desktopApp = require('trustgraph-common/desktop_app.js');
var objectHash = require('trustgraph-common/object_hash.js');
...
function witness(onDone){
	...
	var composer = require('trustgraph-common/composer.js');
